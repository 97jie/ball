...
public class MainActivity extends Activity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String scorea = ((TextView)findViewById(R.id.tv_scoreA)).getText().toString();
        String scoreb = ((TextView)findViewById(R.id.tv_scoreB)).getText().toString();
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.tv_scoreA)).setText(scorea);
        ((TextView)findViewById(R.id.tv_scoreB)).setText(scoreb);
    }
